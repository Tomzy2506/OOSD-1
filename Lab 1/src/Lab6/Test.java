...
public class Test 
{
	public static void main(String[] args) 
	{
	      ...
	      //Note the shortcut technique here for iterating through an array.
	      {
	         if (t1.addCourse(course)) 			
	         //Note that addCourse returns a boolena to indicate success or not.
	         {
	      ...
	      for (String course: courses)
	      //Note that removeCourse returns a boolena to indicate success or not.
	      {
